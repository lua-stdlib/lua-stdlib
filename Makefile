...
DIST_COMMON = README $(am__configure_deps) $(dist_data_DATA) \
	...
	$(top_srcdir)/src/std.lua.in AUTHORS INSTALL \
	build-aux/install-sh build-aux/missing
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
am__aclocal_m4_deps = $(top_srcdir)/m4/ax_compare_version.m4 \
	$(top_srcdir)/m4/ax_lua.m4 $(top_srcdir)/configure.ac
am__configure_deps = $(am__aclocal_m4_deps) $(CONFIGURE_DEPENDENCIES) \
	$(ACLOCAL_M4)
am__CONFIG_DISTCLEAN_FILES = config.status config.cache config.log \
 configure.lineno config.status.lineno
mkinstalldirs = $(install_sh) -d
CONFIG_CLEAN_FILES = luarocks-config.lua src/std.lua
...
ACLOCAL = ${SHELL} /home/rrt/Software/Lua/lua-stdlib/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AUTOCONF = ${SHELL} /home/rrt/Software/Lua/lua-stdlib/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/rrt/Software/Lua/lua-stdlib/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/rrt/Software/Lua/lua-stdlib/build-aux/missing --run automake-1.11
AWK = gawk
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"stdlib\" -DPACKAGE_TARNAME=\"stdlib\" -DPACKAGE_VERSION=\"29\" -DPACKAGE_STRING=\"stdlib\ 29\" -DPACKAGE_BUGREPORT=\"rrt@sc3d.org\" -DPACKAGE_URL=\"\" -DPACKAGE=\"stdlib\" -DVERSION=\"29\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LUA_VERSION = 5.2
MAKEINFO = ${SHELL} /home/rrt/Software/Lua/lua-stdlib/build-aux/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = stdlib
PACKAGE_BUGREPORT = rrt@sc3d.org
PACKAGE_NAME = stdlib
PACKAGE_STRING = stdlib 29
...
STRIP = 
VERSION = 29
abs_builddir = /home/rrt/Software/Lua/lua-stdlib
abs_srcdir = /home/rrt/Software/Lua/lua-stdlib
abs_top_builddir = /home/rrt/Software/Lua/lua-stdlib
abs_top_srcdir = /home/rrt/Software/Lua/lua-stdlib
am__leading_dot = .
am__tar = $${TAR-tar} chof - "$$tardir"
am__untar = $${TAR-tar} xf -
bindir = /home/rrt/local/bin/x86_64-linux-gnu
build_alias = 
builddir = .
datadir = ${datarootdir}
...
install_sh = ${SHELL} /home/rrt/Software/Lua/lua-stdlib/build-aux/install-sh
libdir = ${exec_prefix}/lib
libexecdir = /home/rrt/local/libexec/x86_64-linux-gnu
...
src/std.lua: $(top_builddir)/config.status $(top_srcdir)/src/std.lua.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
.PHONY: all all-am am--refresh check check-am clean clean-generic dist \
	...
	install-data install-data-am install-dist_dataDATA \
	install-dist_docDATA install-dist_filesDATA \
	install-dist_modulesDATA install-dvi install-dvi-am \
	install-exec install-exec-am install-html install-html-am \
	install-info install-info-am install-man install-pdf \
	install-pdf-am install-ps install-ps-am install-strip \
	installcheck installcheck-am installdirs maintainer-clean \
	maintainer-clean-generic mostlyclean mostlyclean-generic pdf \
	pdf-am ps ps-am uninstall uninstall-am uninstall-dist_dataDATA \
	uninstall-dist_docDATA uninstall-dist_filesDATA \
	uninstall-dist_modulesDATA
...
check-in-release: distcheck
	...
	git tag -a -m "Release tag" release-v$(VERSION) && \
	git push && git push --tags && \
	git checkout master
