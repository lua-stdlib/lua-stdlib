...
-- TODO: Make a new SF project LuaStd
...
-- TODO: precompile and make require check for a .luc version of each
--   file, and load it if it's newer than the .lua version.

require "std/patch40.lua"
require "std/data.lua"
require "std/text.lua"
require "std/time.lua"
require "std/io.lua"
